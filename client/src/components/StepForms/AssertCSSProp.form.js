...
import { CHANGE_PROPERTY, CHANGE_SIGN, CHANGE_TEXT, CHANGE_COMPARATOR } from '../../constants/StepTypes/AssertCSSProp.types'
import { signOptions, comparatorOptions} from 'constants/Selects'

AssertCSSPropForm.propTypes = {
}

export default function AssertCSSPropForm(props) {
