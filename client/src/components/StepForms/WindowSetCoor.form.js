...
import { CHANGE_X_COOR, CHANGE_Y_COOR } from '../../constants/StepTypes/WindowSetCoor.types'

WindowSetCoorForm.propTypes = {
}

export default function WindowSetCoorForm(props) {
