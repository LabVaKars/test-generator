...
AssertElemTagNameRow.propTypes = {
	id: PropTypes.number,
}


export default function AssertElemTagNameRow(props) {
	...
	return (
		<div>
            Assert that tag name of element with css value "<span className="text-danger">{parentForm.cssSelector}</span>"&nbsp;
