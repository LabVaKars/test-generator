...
import { CHANGE_SIGN, CHANGE_TEXT, CHANGE_COMPARATOR } from '../../constants/StepTypes/AssertElemTagName.types'
import { signOptions, comparatorOptions} from 'constants/Selects'

AssertElemTagNameForm.propTypes = {
}

export default function AssertElemTagNameForm(props) {
