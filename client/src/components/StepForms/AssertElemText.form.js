...
import { CHANGE_SIGN, CHANGE_TEXT, CHANGE_COMPARATOR } from '../../constants/StepTypes/AssertElemText.types'
import { signOptions, comparatorOptions} from 'constants/Selects'

AssertElemTextForm.propTypes = {
}

export default function AssertElemTextForm(props) {
