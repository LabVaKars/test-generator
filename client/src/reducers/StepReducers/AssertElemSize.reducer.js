...
import { CHANGE_WIDTH, CHANGE_HEIGHT } from '../../constants/StepTypes/AssertElemSize.types'
...
const AssertElemSizeReducer = (state, action) => {
	let handle = handlers[action.type] || handlers.DEFAULT
	return handle(state, action)
}

export default AssertElemSizeReducer