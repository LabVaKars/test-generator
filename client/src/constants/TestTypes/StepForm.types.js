...
export const MOVE_STEP =                `${PREFIX}:MOVE_STEP`
export const SET_ERRORS =               `${PREFIX}:SET_ERRORS`
export const SAVE_CHANGES =             `${PREFIX}:SAVE_CHANGES`
export const CURRENT_FORM_REDUCER =     `${PREFIX}:CURRENT_FORM_REDUCER`
export const CHANGE_STEP_BY_ID =        `${PREFIX}:CHANGE_STEP_BY_ID`
